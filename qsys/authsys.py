...
_MENU_SEED = [
    ...
    ("我的", "量化驾驶舱", "🚀", "menu", "dash", "page:dash", 0),
        ...
        ("📡 iFinD数据", "财务报表", "📊", "menu", "ifind-financial", "page:ifind-financial", 6),
        ("📡 iFinD数据", "舆情/新闻", "📰", "menu", "newsense", "page:newsense", 7),
        ("📡 iFinD数据", "接口文档", "📖", "menu", "ifind-doc", "page:ifind-doc", 8),
        ("📡 iFinD数据", "数据仓库", "🗄", "menu", "ifind-warehouse", "page:ifind-warehouse", 9),
