...
_MENU_SEED = [
    ...
    ("我的", "量化驾驶舱", "🚀", "menu", "dash", "page:dash", 0),
        ...
        ("📡 iFinD数据", "资金流向", "💰", "menu", "fundflow", "page:fundflow", 5),
        ("📡 iFinD数据", "财务报表", "📊", "menu", "ifind-financial", "page:ifind-financial", 7),
        ("📡 iFinD数据", "舆情/新闻", "📰", "menu", "newsense", "page:newsense", 8),
        ("📡 iFinD数据", "接口文档", "📖", "menu", "ifind-doc", "page:ifind-doc", 9),
        ("📡 iFinD数据", "数据仓库", "🗄", "menu", "ifind-warehouse", "page:ifind-warehouse", 10),
        ...
        (None, "监控面板", "🖥️", "dir", None, None, 5),
        ("监控面板", "运行日志中心", "🧾", "menu", "runtime-logs", "page:runtime-logs", 1),
        (None, "系统", "⚙️", "dir", None, None, 6),
        ("系统", "设置", "⚙️", "menu", "settings", "page:settings", 1),
        (None, "系统管理", "🔐", "dir", None, None, 7),
